...
#ifdef INADDR_ANY
    sock_define_uconst("INADDR_ANY", INADDR_ANY);
#else
    sock_define_uconst("INADDR_ANY", 0x00000000);
#endif

#ifdef INADDR_BROADCAST
    sock_define_uconst("INADDR_BROADCAST", INADDR_BROADCAST);
#else
    sock_define_uconst("INADDR_BROADCAST", 0xffffffff);
#endif

#ifdef INADDR_LOOPBACK
    sock_define_uconst("INADDR_LOOPBACK", INADDR_LOOPBACK);
#else
    sock_define_uconst("INADDR_LOOPBACK", 0x7F000001);
#endif

#ifdef INADDR_UNSPEC_GROUP
    sock_define_uconst("INADDR_UNSPEC_GROUP", INADDR_UNSPEC_GROUP);
#else
    sock_define_uconst("INADDR_UNSPEC_GROUP", 0xe0000000);
#endif

#ifdef INADDR_ALLHOSTS_GROUP
    sock_define_uconst("INADDR_ALLHOSTS_GROUP", INADDR_ALLHOSTS_GROUP);
#else
    sock_define_uconst("INADDR_ALLHOSTS_GROUP", 0xe0000001);
#endif

#ifdef INADDR_MAX_LOCAL_GROUP
    sock_define_uconst("INADDR_MAX_LOCAL_GROUP", INADDR_MAX_LOCAL_GROUP);
#else
    sock_define_uconst("INADDR_MAX_LOCAL_GROUP", 0xe00000ff);
#endif

#ifdef INADDR_NONE
    sock_define_uconst("INADDR_NONE", INADDR_NONE);
#else
    sock_define_uconst("INADDR_NONE", 0xffffffff);
#endif
